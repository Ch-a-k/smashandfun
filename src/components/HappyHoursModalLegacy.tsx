...
/**
 * Legacy версия попапа HAPPY HOURS (старый дизайн).
 * Нужна для быстрого отката/сравнения.
 */
export default function HappyHoursModalLegacy({ isOpen, onClose }: HappyHoursModalProps) {
  const { t } = useI18n();
